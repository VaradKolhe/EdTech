      ...
      <header className="flex items-center justify-between border-b border-gray-200 bg-white px-4 py-3 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:px-6 sm:py-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden text-right sm:block">
            <p className="text-sm font-semibold text-gray-900 dark:text-white">{user?.fullName || "Teacher"}</p>
            <p className="text-xs text-gray-500 dark:text-gray-400">Teacher workspace</p>
          </div>
          <button
            onClick={() => {
              logout();
            ...
            className="rounded-lg border border-gray-200 px-3 py-2 text-sm font-semibold text-gray-600 transition-colors hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-700"
          >
            Logout
          </button>
        </div>
              ...
              return (
                ...
                >
                  <div className="grid gap-0 md:grid-cols-[190px_1fr]">
                    <button
                      type="button"
                      onClick={() => navigate(`/teacher-dashboard/courses/${c._id}`)}
