  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-slate-50 dark:bg-[#0b0e14]">
        <Navbar />
        <div className="py-24 text-center text-slate-500">Preparing your dashboard...</div>
      </div>
    );
  }
      ...
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <header className="mb-10 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 text-slate-500">Continue learning and discover courses matched to your profile.</p>
          </div>
        ...
        <div className="mb-10 grid gap-5 sm:grid-cols-3">
          <Stat icon={BookOpenIcon} label="Enrolled" value={data.stats.enrolledCount} />
          <Stat icon={TrophyIcon} label="Completed" value={data.stats.completedCount} />
        ...
        <section className="mb-12">
          <div className="mb-5 flex items-center justify-between">
            ...
            <Link to="/student-dashboard/my-courses" className="text-sm font-bold text-brand-600">View all</Link>
          </div>
        ...
        <section className="mb-12">
          <div className="mb-5 flex items-center gap-2">
            ...
            <h2 className="text-2xl font-black text-slate-900 dark:text-white">Recommended courses</h2>
          </div>
          {data.recommendations.length ? (
            ...
            <div className="rounded-2xl border border-dashed border-slate-300 p-10 text-center text-slate-500 dark:border-slate-700">
              Recommendations will appear after more courses are published.
            </div>
          )}
        </section>

        <section>
          <h2 className="mb-5 text-2xl font-black text-slate-900 dark:text-white">Recent activity</h2>
          <div className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-[#161b22]">
