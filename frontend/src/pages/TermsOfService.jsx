    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <main className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <p>Welcome to EduLearn. By accessing or using our platform, you agree to comply with and be bound by these Terms of Service.</p>
          ...
          <p>All content on the platform, including videos, text, and logos, is the property of EduLearn or its content creators and is protected by copyright laws.</p>
          <h2>5. Termination</h2>
